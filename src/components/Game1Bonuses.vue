      ...
      <div class="wrapper-motion">
        ...
        <div class="wrapper-cards">
            <div>
             ...
             <Card v-if='selectCardPlayer2' @bonus-event="handleBonusEvent"  :stronger='countCardBonusesPlayer2' :win='winPlayer2' :actives='activeCardBonusesPlayer2' :category='10' :card='selectCardPlayer2' :player='2'
