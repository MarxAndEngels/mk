...
<div class='game-wrap'>
    <div class="game-upper" v-show='start && randomSelectionCards && game_over == false'>
      <div class="wrapper-motion">
       ...
       <div class="wrapper-buttons third" v-if='countPlayers == 3'> 
         <transition name="fade">
        ...
        <div class="wrapper-cards">
            <div>
                ...
                <Card v-if='selectCardPlayer1' @bonus-event="handleBonusEvent" :stronger='countCardBonusesPlayer1' :actives='activeCardBonusesPlayer1' :win='winPlayer1' :category='selectCategory' :card='selectCardPlayer1' :player='1'/>
                </div>
             ...
             <Card v-if='selectCardPlayer2' @bonus-event="handleBonusEvent" :stronger='countCardBonusesPlayer2' :actives='activeCardBonusesPlayer2' :win='winPlayer2' :category='selectCategory' :card='selectCardPlayer2' :player='2'/>
             </div>
             <!-- <img class='card-vs' :src="`/img/vs.webp`" alt="">
            <Card v-if='selectCardPlayer2' :card='selectCardPlayer2' :animation='animationCard2'/> -->
        </div>
        <div class="wrapper-cards-for-third" v-if='countPlayers == 3'>
            <!-- <Card v-if='selectCardPlayer2' :category='round' :card='selectCardPlayer2' :player='3'/> -->
        </div>
      <div class="wrapper-buttons" v-if='countPlayers == 2'> 
        <transition name="fade">
      <div class="button fight" v-show='fightState' @click="playFight">
        {{  language == 'eng' ? 'Fight' : 'В бой'  }}
      </div>  
    ...
    <div class="wrapper-text-win" v-show='game_over==true && game_over_text != ""'>
        ...
        <div class="text-win-button red" @click.prevent="relocateHome"> {{  language == 'eng' ? 'Select another game' : 'Выбрать другую игру'  }}</div>
    </div>
...
const selectPlayerHandler = () =>{
    ...
    playRound()
        ...
        //получает рандомные карты
    randomSelectionCardsBonuses.value = getRandomCardsFisher(bonuses, 4)
